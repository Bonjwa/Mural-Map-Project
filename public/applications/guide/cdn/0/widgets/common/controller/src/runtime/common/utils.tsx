...
import { css, React, Size, ReactRedux, IMState, appActions, getAppStore, WidgetState, IMSizeModeLayoutJson, LayoutItemType } from 'jimu-core';
...
/**
 * Get Style for poppers that host child widget
 */
export const usePopperStyle = () => {
  const theme = useSelector((state: IMState) => state.theme)
  return css`
    > .panel-header {
      .action-close {
