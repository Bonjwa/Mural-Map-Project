/** @jsx jsx */
import { jsx, React, Immutable, classNames } from 'jimu-core';
import { IMSizeMap, DisplayType } from '../../config';
import { ControlPosition, FloatingPanel } from 'jimu-ui';
import { useFigureOutLayouts, useGetWidgetTitle, usePopperStyle } from '../common/utils';
...
export const MultipleWidgetsLuncher = (props: MultipleWidgetsLuncherProps) => {
  ...
  const popperStyle = usePopperStyle()
